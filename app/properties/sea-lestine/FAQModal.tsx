...
const FAQS: FAQItem[] = [
  ...
  {
    q: "Is there a baby pool?",
    a: "Yes, Sea Lestine has a dedicated baby pool section alongside the main 16×20 ft private pool — ideal for families with young children.",
    category: "stay",
  },
  {
    q: "Is food available at the villa?",
    a: "The caretaker can provide home-cooked, authentic local-style meals at extra charges. There is no obligation to order — guests can also order via Zomato/Swiggy, with multiple nearby restaurants available.",
    category: "stay",
  },
  {
    q: "Can we order food delivery?",
    a: "Yes, Zomato and Swiggy deliveries work in this area. Multiple restaurants are accessible within a short drive from the villa.",
    category: "stay",
  },
  {
    q: "Is the caretaker available 24/7?",
    a: "A caretaker is available on-site during the day and reachable by phone at all times. They assist with housekeeping, basic requests, and any issues during your stay.",
    category: "stay",
  },
  {
    q: "Is parking available at the villa?",
    a: "Yes, Sea Lestine has dedicated parking space for up to 2 cars within the property premises.",
    category: "stay",
  },
  {
    q: "How far is Varsoli Beach?",
    a: "Varsoli Beach is approximately 2 km from Sea Lestine — about a 5-minute drive.",
    category: "stay",
  },
  {
    q: "Can we bring pets?",
    a: "Pets are not permitted at Sea Lestine.",
    category: "stay",
  },
  // Bookings & Payment
  {
  ...
  },
  {
    ...
    a: "Only registered guests may use the villa facilities. Day visitors are not permitted without prior approval from the caretaker.",
    category: "rules",
  },
  {
