...
const FAQS_INLINE = [
  {
    ...
    content:
      "The caretaker can provide home-cooked, authentic local-style meals at extra charges. There is no compulsion to order from us — guests can also order from Zomato/Swiggy, with multiple nearby restaurants available.",
  },
  {
    heading: "Is there a baby pool?",
    content:
      "Yes, Sea Lestine has a dedicated baby pool section alongside the main 16×20 ft private pool — perfect for families with young children.",
  },
  {
    heading: "How far is Varsoli Beach?",
    content:
      "Varsoli Beach is approximately 2 km from Sea Lestine — about a 5-minute drive.",
  },
  {
    heading: "Is parking available?",
    content:
      "Yes, dedicated parking space for up to 2 cars is available within the property premises.",
  },
];
