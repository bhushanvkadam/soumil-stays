...
// ─── Image URLs ────────────────────────────────────────────────────────────────
const BASE = "https://ik.imagekit.io/tnf/Soumil%20Stay/Cherrys";
...
const HERO_IMAGE = `${BASE}/_M027373-HDR.jpg`;

const ALL_IMAGES = [
  `${BASE}/_M027373-HDR.jpg`,
  `${BASE}/_M027498-HDR.jpg`,
  `${BASE}/_M027598-HDR.jpg`,
  `${BASE}/_M027633-HDR.jpg`,
  `${BASE}/_M027583-HDR.jpg`,
  `${BASE}/_M027543-HDR.jpg`,
  `${BASE}/_M027358-HDR.jpg`,
  `${BASE}/_M027718-HDR.jpg`,
  `${BASE}/_M027368-HDR.jpg`,
  `${BASE}/_M027318-HDR.jpg`,
  `${BASE}/_M027518-HDR.jpg`,
  `${BASE}/_M027313-HDR.jpg`,
  `${BASE}/_M027653-HDR.jpg`,
  `${BASE}/_M027403-HDR.jpg`,
  `${BASE}/_M027488-HDR.jpg`,
  `${BASE}/_M027613-HDR.jpg`,
  `${BASE}/_M027683-HDR.jpg`,
  `${BASE}/_M027658-HDR.jpg`,
  `${BASE}/_M027428-HDR.jpg`,
  `${BASE}/_M027713-HDR.jpg`,
  `${BASE}/_M027328-HDR.jpg`,
  `${BASE}/_M027463-HDR.jpg`,
  `${BASE}/_M027508-HDR.jpg`,
  `${BASE}/_M027338-HDR.jpg`,
  `${BASE}/_M027628-HDR.jpg`,
  `${BASE}/_M027408-HDR.jpg`,
  `${BASE}/_M027668-HDR.jpg`,
  `${BASE}/_M027438-HDR.jpg`,
  `${BASE}/_M027538-HDR.jpg`,
  `${BASE}/_M027418-HDR.jpg`,
  `${BASE}/_M027603-HDR.jpg`,
  `${BASE}/_M027458-HDR.jpg`,
  `${BASE}/_M027473-HDR.jpg`,
  `${BASE}/_M027723-HDR.jpg`,
  `${BASE}/_M027698-HDR.jpg`,
  `${BASE}/_M027568-HDR.jpg`,
  `${BASE}/_M027558-HDR.jpg`,
  `${BASE}/_M027443-HDR.jpg`,
];
...
export default function CherryPage() {
  const property = getPropertyBySlug("cherry");
  ...
  return (
    <>
      ...
      <div className="bg-white border-b border-stone-100">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3">
          <nav className="flex items-center gap-2 text-xs text-gray-400 font-sans">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Cherry</span>
          </nav>
        </div>
      </div>
          ...
          <div className="flex flex-col pb-24 lg:pb-0">
            ...
            <div className="pb-6">
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-1 mt-4 text-xs text-gray-400">
                {["500m from Alibag Bus Stand", "1km from Alibag Beach", "18km from Mandwa Jetty"].map((n) => (
            ...
            <div className="mt-10 pt-10 border-t border-stone-100">
              ...
              <div className="rounded-2xl overflow-hidden border border-stone-200">
                <iframe
                  src="https://maps.google.com/maps?q=Alibag+Bus+Stand,+Alibag,+Maharashtra&z=15&output=embed"
                  width="100%"
                  height="360"
                  ...
                  title="Cherry apartment location map"
                />
              </div>
              <div className="flex items-center justify-between mt-3 flex-wrap gap-3">
                ...
                <a
                  href="https://maps.app.goo.gl/BuB25aSuSVAxEddx6"
                  target="_blank"
      ...
      {/* More Properties in Alibag */}
      <section className="pt-16 pb-24 lg:pb-16 px-4 md:px-8 bg-[#F8F9FA] border-t border-stone-100">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-heading text-3xl text-foreground mb-1">More Properties in Alibag</h2>
