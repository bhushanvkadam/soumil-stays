...
const FAQS: FAQItem[] = [
  ...
  {
    q: "Can we bring pets?",
    a: "Pets are not permitted at Killa Villa.",
    category: "stay",
  },
  {
    q: "Is the kitchen fully equipped?",
    a: "The kitchen has a refrigerator, microwave, induction cooktop, and basic cookware. Guests are welcome to cook. Catering can be arranged on request.",
    category: "stay",
  },
  {
    q: "How far is the nearest hospital?",
    a: "Alibag Civil Hospital is approximately 5 km away, about 15 minutes by car.",
    category: "stay",
  },
  {
    q: "Is parking available at the villa?",
    a: "Yes, Killa Villa has dedicated private parking for up to 2 cars within the property premises.",
    category: "stay",
  },
  // Bookings & Payment
  {
  ...
  },
  {
    ...
    a: "Smoking is strictly prohibited inside the villa and all indoor areas. A designated outdoor smoking area is available on the lawn.",
    category: "rules",
  },
];
