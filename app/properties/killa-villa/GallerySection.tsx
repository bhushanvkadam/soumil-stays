...
const VIMEO_SRC =
  "https://player.vimeo.com/video/36016501?autoplay=1&muted=0&loop=1";
...
export default function GallerySection({ heroImage, allImages }: Props) {
  ...
  // 4 preview photo tiles (indices 1–4 from allImages; index 0 is a duplicate of heroImage)
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-4 pb-2">
        {/*
          Desktop: 3-column grid, video spans 2 rows (col 1), 4 photos fill 2×2 (cols 2-3).
          Heights: video 420px = 2 × photo(204px) + gap(12px). ✓
          Mobile:  2-column grid, video spans full width (col-span-2),
                   4 photos below in a 2×2 grid.
        */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3 rounded-2xl overflow-hidden">
          ...
          <div
            ...
            role="button"
            aria-label="Watch Killa Villa video"
          >
            <Image
              src={heroImage}
              alt="Killa Villa — watch video"
              fill
      ...
      {viewAllOpen && (
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-4 flex-shrink-0">
            <p className="text-white/60 text-sm font-sans">{allImages.length} Photos · Killa Villa</p>
            <button
