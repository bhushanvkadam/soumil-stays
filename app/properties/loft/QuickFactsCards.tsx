...
const HOUSE_RULES = [
  ...
  },
  {
    ...
    content:
      "Only registered guests may use the villa facilities. Day visitors are not permitted without prior approval.",
  },
  {
...
const QUICK_FACTS = [
  ...
  { label: "Max Guests", value: "4 Guests", icon: "👥" },
  { label: "Caretaker", value: "TBD", icon: "🏠" },
];
    ...
    <>
      ...
      <Modal isOpen={activeModal === "todo"} onClose={close} title="Things To Do Nearby">
        <div className="flex flex-col items-center justify-center py-10 text-center gap-3">
          <div className="w-12 h-12 rounded-full bg-stone-100 flex items-center justify-center text-gray-300">
