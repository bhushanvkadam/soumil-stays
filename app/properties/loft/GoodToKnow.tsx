...
const RULES = [
  ...
  },
  {
    ...
    content:
      "Smoking is strictly prohibited inside the villa and all indoor areas. A designated outdoor area is available.",
  },
  {
...
const FAQS_INLINE = [
  {
    ...
    content:
      "Loft does not offer in-house meals, catering, or caretaker-cooked food. A restaurant approximately 1 km from the property provides a full menu. Guests coordinate directly with the restaurant for their meals.",
  },
  {
    heading: "Is there power backup?",
    content:
      "Yes, Loft has both an inverter and a generator backup, ensuring uninterrupted power supply throughout your stay.",
  },
  {
    heading: "Is there a pool?",
    content:
      "No, Loft does not have a pool. It is a peaceful retreat designed for scenic relaxation and sea views.",
  },
  {
    heading: "Can we bring pets?",
    content: "Pets are not permitted at Loft.",
  },
];
