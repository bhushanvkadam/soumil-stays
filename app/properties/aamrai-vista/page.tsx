...
// ─── Image URLs ────────────────────────────────────────────────────────────────
const BASE = "https://ik.imagekit.io/tnf/Soumil%20Stay/Aamrai%20Vista";
...
const ALL_IMAGES = [
  HERO_IMAGE,
  `${BASE}/Screenshot%202026-08-11%20at%2008.21.50.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.21.58.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.22.06.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.22.13.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.22.21.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.22.30.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.22.38.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.22.46.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.22.53.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.23.01.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.23.09.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.23.17.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.23.23.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.23.30.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.23.36.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.23.43.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.23.50.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.23.57.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.24.04.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.24.12.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.24.20.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.24.27.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.24.34.png`,
  `${BASE}/Screenshot%202026-08-11%20at%2008.24.49.png`,
];

// ─── What's Nearby ─────────────────────────────────────────────────────────────
const NEARBY = [
  { place: "Varsoli Beach", distance: "250 m", time: "3 min walk" },
  { place: "Alibag Beach", distance: "2.5 km", time: "8 min drive" },
  { place: "Alibag Bus Stand", distance: "2 km", time: "7 min drive" },
  { place: "Thal Beach", distance: "7 km", time: "20 min drive" },
  { place: "Nagaon Beach", distance: "10 km", time: "25 min drive" },
  { place: "Mandwa Jetty", distance: "17 km", time: "30 min drive" },
];
...
const SIMILAR = [
  ...
  },
  {
    ...
    bedrooms: 4,
    pool: true,
    image: `${KV_BASE}/Screenshot%202026-06-01%20at%2008.10.39.png`,
    href: "#",
  },
];
...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default function AamraiVistaPage() {
  const property = getPropertyBySlug("aamrai-vista");
      ...
      <div className="bg-white border-b border-stone-100">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3">
          <nav className="flex items-center gap-2 text-xs text-gray-400 font-sans">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Aamrai Vista</span>
          </nav>
        </div>
      </div>
          ...
          <div className="flex flex-col pb-24 lg:pb-0">
            ...
            <div className="pb-6">
              ...
              <div className="flex flex-wrap gap-x-4 gap-y-1 mt-4 text-xs text-gray-400">
                {["250m from Varsoli Beach", "2.5km from Alibag Beach", "17km from Mandwa Jetty"].map((n) => (
            ...
            <div className="mt-10 pt-10 border-t border-stone-100">
              ...
              <div className="rounded-2xl overflow-hidden border border-stone-200">
                <iframe
                  src="https://maps.google.com/maps?q=Varsoli+Beach,+Alibag,+Maharashtra&z=15&output=embed"
                  width="100%"
                  height="360"
                  ...
                  title="Aamrai Vista location map"
                />
              </div>
              <div className="flex items-center justify-between mt-3 flex-wrap gap-3">
                ...
                <a
                  href="https://maps.app.goo.gl/wDiYkCyuHkKSHn8e9"
                  target="_blank"
