...
const FAQS: FAQItem[] = [
  // Stay & Rooms
  {
    ...
    a: "Yes, Aamrai Vista has a dedicated baby pool section alongside the main 16×22 ft private pool — ideal for families with young children.",
    category: "stay",
  },
  {
  ...
  },
  {
    ...
    a: "The caretaker can provide home-cooked, authentic local-style meals at extra charges. There is no obligation to order from the property — guests can order via Zomato/Swiggy or visit multiple nearby restaurants.",
    category: "stay",
  },
  {
    q: "Can we order food delivery?",
    a: "Yes, Zomato and Swiggy deliveries work in this area. Multiple restaurants are also accessible within a short drive from the villa.",
    category: "stay",
  },
  {
    q: "Is parking available?",
    a: "Yes, Aamrai Vista has dedicated parking for up to 7 cars within the property premises.",
    category: "stay",
  },
  {
    q: "How far is Varsoli Beach?",
    a: "Varsoli Beach is just 250 metres from Aamrai Vista — approximately a 3-minute walk.",
    category: "stay",
  },
  {
    q: "How far is the nearest hospital?",
    a: "Alibag Civil Hospital is approximately 4–5 km away, about 12–15 minutes by car.",
    category: "stay",
  },
  // Bookings & Payment
  {
