...
const FAQS_INLINE = [
  {
    heading: "What are the pool dimensions?",
    content:
      "Suruchi has a 25×55 ft private swimming pool — one of the largest private pools in Alibag — with a big gazebo attached and a connected private lawn.",
  },
  {
    heading: "How many bedrooms, and what is the floor layout?",
    content:
      "There are 6 fully air-conditioned bedrooms: 2 on the Ground Floor and 4 on the First Floor. There are 7 bathrooms in total — 6 attached and 1 common.",
  },
  {
    heading: "Is food available at the villa?",
    content:
      "Soumil's Stays runs its own restaurant chain in Alibag, but there's no compulsion to order from us. Guests are free to order from Zomato or Swiggy, and multiple restaurants are available nearby.",
  },
  {
    heading: "Is parking available?",
    content:
      "Yes, Suruchi has dedicated parking for up to 8 cars within the property.",
  },
];
