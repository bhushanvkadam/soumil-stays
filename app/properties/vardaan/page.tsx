...
// ─── Image URLs ────────────────────────────────────────────────────────────────
const BASE = "https://ik.imagekit.io/tnf/Soumil%20Stay/Vardaan%20Karjat";

const HERO_IMAGE = `${BASE}/24.jpeg`;
...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default function VardaanPage() {
  const property = getPropertyBySlug("vardaan");
      ...
      <div className="bg-white border-b border-stone-100">
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-3">
          <nav className="flex items-center gap-2 text-xs text-gray-400 font-sans">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Vardaan</span>
          </nav>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-8 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 lg:gap-14 items-start">
          ...
          <div className="flex flex-col pb-24 lg:pb-0">
            ...
            {/* Location — placeholder, no maps link provided */}
            <div className="mt-10 pt-10 border-t border-stone-100">
              ...
              <div className="flex items-center justify-between mt-3 flex-wrap gap-3">
                ...
                <a
                  href="https://maps.google.com/maps?q=New+Matheran+Karjat+Maharashtra"
                  target="_blank"
