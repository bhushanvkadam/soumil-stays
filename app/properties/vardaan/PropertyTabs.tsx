    ...
    <div className="py-8 flex flex-col gap-5">
      <div className="border-l-4 border-forest bg-[#01B9C5]/5 rounded-r-xl p-5">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          Vardaan&apos;s setting is its signature — a thoughtfully designed villa inside the
          New Matheran gated community, surrounded by Sahyadri mountains and seasonal
          waterfalls. Step onto the large terrace and the view stretches across forested
          peaks. This is a place built for people who want to properly disconnect.
        </p>
      </div>
      <p className="text-gray-600 text-[15px] leading-relaxed">
        Wake up to mountain air. At Vardaan, mornings begin on a large terrace with
        panoramic mountain views, the sound of the Sahyadri breeze, and nothing on the
        agenda but deciding whether to trek or simply sit still. This is a villa designed
        for people who want to feel genuinely away.
      </p>
      <p className="text-gray-600 text-[15px] leading-relaxed">
        Vardaan is a well-designed 2-bedroom villa inside the New Matheran gated community,
        Karjat — both bedrooms air-conditioned with attached washrooms, a comfortable AC
        living area, and a basic kitchen with an induction cooktop and essential utensils.
        The property is ideal for couples and small families seeking a quiet, comfortable
        mountain retreat.
      </p>
      ...
      <div className="flex items-start gap-3 p-4 bg-amber-50 rounded-xl border border-amber-200">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-amber-800 leading-relaxed">
            Vardaan is in a remote, peaceful location. Nearest restaurants are approximately
            18 km away. A local Chinese food outlet is ~7 km away. A cook can be arranged
            for simple home-style meals at additional charges, but requires prior notice —
            cook&apos;s contact details are shared only after booking confirmation.{" "}
            <strong>Guests are strongly advised to stock up on groceries, snacks,
            drinking water, and daily essentials before reaching the property.</strong>
          </p>
        </div>
      </div>
    ...
    <div className="py-8 flex flex-col gap-6">
      {REVIEWS.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center gap-3">
          ...
          <p className="text-xs text-gray-400">Be among the first to stay at Vardaan and share your experience.</p>
        </div>
      ) : (
        <>
            ...
            {REVIEWS.map(({ text, reviewer, date, rating, guests, nights }) => (
              ...
              >
                ...
                <div className="pt-3 border-t border-stone-100">
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">Vardaan</p>
                </div>
              </div>
            ))}
          </div>
