...
export default function GallerySection({ heroImage, allImages }: Props) {
  ...
  // 4 preview photo tiles (indices 1–4 from allImages)
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-4 pb-2">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-3 rounded-2xl overflow-hidden">
          ...
          <div
            ...
            role="button"
            aria-label="View Vardaan photos"
          >
            <Image
              src={heroImage}
              alt="Vardaan — mountain view"
              fill
      ...
      {viewAllOpen && (
        ...
        >
          <div className="flex items-center justify-between px-6 py-4 flex-shrink-0">
            <p className="text-white/60 text-sm font-sans">{allImages.length} Photos · Vardaan</p>
            <button
