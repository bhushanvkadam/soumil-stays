...
export default function EnquiryCard() {
  ...
  const handleEnquire = () => {
    const parts = [
      `Hi, I'd like to book Parvata Vista in New Matheran, Karjat.`,
  ...
  return (
    <aside id="enquiry" className="lg:sticky lg:top-24 self-start bg-white border border-stone-200 rounded-2xl p-6 shadow-sm">
      ...
      {/* Caretaker / cook TBD notice */}
      <div className="mb-5 flex items-start gap-2.5 p-3 bg-stone-50 rounded-xl border border-stone-200">
        ...
        <p className="text-xs text-gray-500 leading-relaxed">
          <span className="font-medium text-foreground">Caretaker &amp; cook details:</span> Shared only after reservation is confirmed.
        </p>
      </div>
