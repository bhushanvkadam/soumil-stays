      ...
      {viewAllOpen && (
        ...
        >
          <div className="flex items-center justify-between px-6 py-4 flex-shrink-0">
            <p className="text-white/60 text-sm font-sans">{allImages.length} Photos · Parvata Vista</p>
            <button
